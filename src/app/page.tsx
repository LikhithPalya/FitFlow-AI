    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      <header className="bg-gray-900 p-4">
        <nav className="container mx-auto flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold">FitFlow AI</Link>
          <div className="flex space-x-4">
            <Link href="/about" className="hover:text-gray-300">About</Link>
            <Link href="/contact" className="hover:text-gray-300">Contact</Link>
            <a href="https://www.example.com" className="hover:text-gray-300" target="_blank">Example Link</a>
          </div>
        </nav>
      </header>
      ...
      <footer className="bg-gray-900 text-gray-400 p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="mailto:example@example.com" className="hover:text-gray-300">example@example.com</a>
